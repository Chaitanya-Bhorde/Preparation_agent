...
const codingProblems = [
  {
    ...
    functionSignature: {
      ...
      python: { name: 'solve', params: [{ name: 'input', type: 'string' }], returnType: 'List[int]' },
  ...
  },
  {
    ...
    functionSignature: {
      ...
      python: { name: 'solve', params: [{ name: 's', type: 'string' }], returnType: 'int' },
      java: { name: 'solve', params: [{ name: 's', type: 'String' }], returnType: 'int' },
      cpp: { name: 'solve', params: [{ name: 's', type: 'string' }], returnType: 'int' },
    },
    timeLimitMs: 2000,
    memoryLimitKb: 256,
  },
  {
    ...
    functionSignature: {
      javascript: { name: 'solve', params: [{ name: 'input', type: 'string' }], returnType: 'number' },
      python: { name: 'solve', params: [{ name: 'input', type: 'string' }], returnType: 'int' },
      java: { name: 'solve', params: [{ name: 'input', type: 'String' }], returnType: 'int' },
      cpp: { name: 'solve', params: [{ name: 'input', type: 'string' }], returnType: 'int' },
    },
    timeLimitMs: 1500,
    memoryLimitKb: 256,
  },
  {
    ...
    functionSignature: {
      ...
      python: { name: 'solve', params: [{ name: 'nums', type: 'string' }], returnType: 'int' },
      java: { name: 'solve', params: [{ name: 'nums', type: 'int[]' }], returnType: 'int' },
      cpp: { name: 'solve', params: [{ name: 'nums', type: 'vector<int>' }], returnType: 'int' },
    },
    timeLimitMs: 2000,
    memoryLimitKb: 256,
  },
  {
    ...
    functionSignature: {
      ...
      python: { name: 'solve', params: [{ name: 'n', type: 'string' }], returnType: 'int' },
      java: { name: 'solve', params: [{ name: 'n', type: 'int' }], returnType: 'int' },
      cpp: { name: 'solve', params: [{ name: 'n', type: 'int' }], returnType: 'int' },
    },
    timeLimitMs: 1500,
    memoryLimitKb: 256,
  },
  ...
  },
  {
    ...
    functionSignature: {
      ...
      python: { name: 'solve', params: [{ name: 'grid', type: 'string' }], returnType: 'int' },
      java: { name: 'solve', params: [{ name: 'grid', type: 'char[][]' }], returnType: 'int' },
      cpp: { name: 'solve', params: [{ name: 'grid', type: 'vector<vector<char>>' }], returnType: 'int' },
    },
    timeLimitMs: 2500,
    memoryLimitKb: 256,
  },
  ...
  },
  {
    ...
    functionSignature: {
      ...
      python: { name: 'solve', params: [{ name: 'prices', type: 'string' }], returnType: 'int' },
      java: { name: 'solve', params: [{ name: 'prices', type: 'int[]' }], returnType: 'int' },
      cpp: { name: 'solve', params: [{ name: 'prices', type: 'vector<int>' }], returnType: 'int' },
    },
    timeLimitMs: 1500,
    memoryLimitKb: 256,
  },
  {
    ...
    functionSignature: {
      ...
      python: { name: 'solve', params: [{ name: 's', type: 'string' }], returnType: 'List[List[str]]' },
  ...
  },
  {
    ...
    functionSignature: {
      javascript: { name: 'solve', params: [{ name: 'nums', type: 'string' }], returnType: 'number[]' },
      python: { name: 'solve', params: [{ name: 'nums', type: 'string' }], returnType: 'List[int]' },
      java: { name: 'solve', params: [{ name: 'nums', type: 'int[]' }], returnType: 'int[]' },
  ...
  },
  {
    ...
    functionSignature: {
      ...
      python: { name: 'solve', params: [{ name: 'head', type: 'string' }], returnType: 'List[int]' },
  ...
  },
  {
    ...
    functionSignature: {
      ...
      python: { name: 'solve', params: [{ name: 'intervals', type: 'string' }], returnType: 'List[List[int]]' },
